...
const FILTERS = {
  ...
  meal: [
    ...
    { label: 'Drinks',     icon: '🥤', keywords: ['cocktail', 'mocktail', 'smoothie', 'fresh juice', 'cold pressed juice', 'juice recipe', 'lemonade', 'iced tea', 'beverage', 'milkshake', 'margarita', 'sangria', 'spritz', 'fruit punch', 'rum punch', 'party punch', 'holiday punch', 'agua fresca', 'latte', 'cold brew', 'drinking vinegar', 'cocktail syrup', 'simple syrup', 'iced coffee', 'hot chocolate', 'hard cider', 'apple cider drink', 'kombucha', 'milk tea', 'bubble tea', 'chai latte', 'chai tea', 'matcha latte', 'golden milk', 'switchel', 'kefir drink', 'infused water', 'horchata', 'lassi', 'frappe', 'espresso martini', 'ginger beer', 'green juice', 'protein shake', 'mojito', 'daiquiri', 'negroni', 'old fashioned', 'paloma', 'aperol', 'mulled wine', 'wassail', 'tepache', 'fire cider', 'electrolyte drink'] },
  ],
  dietary: [
