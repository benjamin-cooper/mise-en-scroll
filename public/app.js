...
const FILTERS = {
  cuisine: [
    { label: 'Italian',          icon: '🍝', keywords: ['pasta', 'pizza', 'lasagna', 'risotto', 'gnocchi', 'carbonara', 'parmesan', 'pesto', 'linguine', 'fettuccine', 'italian', 'bolognese', 'tiramisu', 'ravioli', 'cannelloni', 'arrabbiata', 'bruschetta', 'focaccia', 'calzone', 'cacio e pepe', 'amatriciana', 'saltimbocca', 'osso buco', 'puttanesca', 'aglio e olio'] },
    { label: 'French',           icon: '🥐', keywords: ['french', 'coq au vin', 'bouillabaisse', 'ratatouille', 'croissant', 'brioche', 'baguette', 'béarnaise', 'bearnaise', 'beurre blanc', 'soufflé', 'souffle', 'cassoulet', 'confit', 'vichyssoise', 'provençal', 'provencal', 'niçoise', 'nicoise', 'gratin', 'tarte tatin', 'madeleines', 'croque', 'pot-au-feu', 'blanquette'] },
    { label: 'Spanish',          icon: '🥘', keywords: ['spanish', 'paella', 'tapas', 'gazpacho', 'patatas bravas', 'tortilla española', 'tortilla espanola', 'croquetas', 'albondigas', 'romesco', 'pan con tomate', 'manchego', 'pisto', 'gambas al ajillo', 'pulpo', 'churro'] },
    { label: 'Mexican',          icon: '🌮', keywords: ['taco', 'burrito', 'enchilada', 'quesadilla', 'salsa', 'guacamole', 'carnitas', 'fajita', 'tortilla', 'mexican', 'tamale', 'elote', 'pozole', 'mole', 'ceviche', 'chipotle', 'birria', 'chile verde', 'chiles rellenos', 'tlayuda', 'sopes', 'huarache'] },
    { label: 'Chinese',          icon: '🥟', keywords: ['chinese', 'stir fry', 'stir-fry', 'wok', 'dim sum', 'kung pao', 'mapo', 'fried rice', 'dumpling', 'wonton', 'szechuan', 'sichuan', 'cantonese', 'char siu', 'lo mein', 'chow mein', 'hot pot', 'bok choy', 'hoisin', 'five spice', 'xiaolongbao', 'dan dan', 'scallion pancake'] },
    { label: 'Japanese',         icon: '🍱', keywords: ['japanese', 'ramen', 'sushi', 'miso', 'teriyaki', 'tempura', 'udon', 'soba', 'tonkatsu', 'katsu', 'donburi', 'onigiri', 'yakitori', 'gyoza', 'okonomiyaki', 'dashi', 'matcha', 'sake', 'rice bowl', 'karaage', 'shabu shabu', 'sukiyaki', 'takoyaki', 'tsukemen'] },
    { label: 'Korean',           icon: '🥘', keywords: ['korean', 'bibimbap', 'bulgogi', 'kimchi', 'gochujang', 'japchae', 'banchan', 'galbi', 'dakgalbi', 'sundubu', 'doenjang', 'pajeon', 'tteok', 'doenjang jjigae', 'army stew', 'samgyeopsal', 'tteokbokki', 'jajangmyeon', 'haemul pajeon'] },
    { label: 'Thai',             icon: '🌿', keywords: ['thai', 'pad thai', 'green curry', 'red curry', 'massaman', 'larb', 'tom yum', 'som tum', 'satay', 'pad see ew', 'khao', 'nam prik', 'yellow curry', 'pad kra pao', 'khao soi', 'tom kha', 'crying tiger'] },
    { label: 'Vietnamese',       icon: '🍲', keywords: ['vietnamese', 'pho', 'banh mi', 'banh', 'bun bo', 'spring roll', 'fresh roll', 'bo kho', 'com tam', 'canh chua', 'bun thit', 'chả giò', 'bun cha', 'cao lau', 'banh xeo'] },
    { label: 'Mediterranean',    icon: '🫒', keywords: ['greek', 'mediterranean', 'shakshuka', 'gyro', 'tzatziki', 'spanakopita', 'moussaka', 'turkish', 'pide', 'borek', 'meze', 'dolma', 'lahmacun', 'baklava', 'couscous', 'moroccan', 'harissa', 'chermoula', 'tagine', 'fatayer', 'pastilla', 'chermoula', 'zaalouk'] },
    { label: 'Middle Eastern',   icon: '🧆', keywords: ['middle eastern', 'lebanese', 'arabic', 'persian', 'iranian', 'israeli', 'jewish', 'falafel', 'hummus', 'shawarma', 'pita', 'tahini', 'za\'atar', 'sumac', 'tabbouleh', 'baba ganoush', 'fattoush', 'kibbeh', 'kabsa', 'mujaddara', 'musakhan', 'ghormeh', 'fesenjan', 'kebab', 'mansaf', 'maqluba', 'sabich'] },
    { label: 'Indian',           icon: '🍛', keywords: ['curry', 'tikka', 'masala', 'dal', 'naan', 'biryani', 'saag', 'paneer', 'tandoori', 'chutney', 'samosa', 'korma', 'vindaloo', 'palak', 'aloo', 'indian', 'chana', 'raita', 'dosa', 'idli', 'uttapam', 'pav bhaji', 'chole', 'butter chicken', 'rogan josh'] },
    { label: 'Filipino',         icon: '🍚', keywords: ['filipino', 'adobo', 'sinigang', 'kare-kare', 'lechon', 'pancit', 'lumpia', 'sisig', 'tinola', 'pinakbet', 'pinoy', 'kaldereta', 'mechado', 'menudo', 'afritada', 'kinilaw', 'dinuguan', 'arroz caldo', 'halo-halo'] },
    { label: 'African',          icon: '🌍', keywords: ['nigerian', 'ethiopian', 'jollof', 'egusi', 'suya', 'injera', 'berbere', 'peri peri', 'piri piri', 'west african', 'ghanaian', 'senegalese', 'akara', 'moi moi', 'ogbono', 'pepper soup', 'ofe', 'waakye', 'thieboudienne', 'doro wat', 'misir wat'] },
    { label: 'American',         icon: '🍔', keywords: ['burger', 'bbq', 'mac and cheese', 'meatloaf', 'pot roast', 'biscuit', 'cornbread', 'chili', 'wings', 'ribs', 'coleslaw', 'pulled pork', 'sloppy', 'casserole', 'ranch', 'buffalo', 'mashed potato', 'gravy', 'biscuits and gravy', 'chicken fried', 'country fried', 'jambalaya', 'gumbo', 'po boy', 'hot dog'] },
    { label: 'Caribbean',        icon: '🌴', keywords: ['caribbean', 'jamaican', 'trinidadian', 'haitian', 'cuban', 'puerto rican', 'jerk', 'plantain', 'rice and peas', 'callaloo', 'roti', 'curry goat', 'oxtail', 'ackee', 'saltfish', 'doubles', 'pelau', 'sorrel', 'escovitch'] },
    { label: 'Eastern European', icon: '🥣', keywords: ['polish', 'czech', 'hungarian', 'ukrainian', 'romanian', 'russian', 'serbian', 'eastern european', 'pierogi', 'borscht', 'schnitzel', 'goulash', 'kielbasa', 'sauerkraut', 'stroganoff', 'cabbage roll', 'perogies', 'halupki', 'paczki', 'babka', 'varenyky'] },
  ],
  protein: [
    { label: 'Chicken',    icon: '🍗', keywords: ['chicken', 'poultry'] },
    { label: 'Beef',       icon: '🥩', keywords: ['beef', 'steak', 'brisket', 'burger', 'meatball', 'ground beef', 'pot roast', 'short rib', 'flank', 'chuck', 'sirloin', 'ribeye', 'prime rib', 'smash burger', 'corned beef', 'braised beef', 'beef tenderloin'] },
    { label: 'Pork',       icon: '🥓', keywords: ['pork', 'bacon', 'ham', 'prosciutto', 'pancetta', 'sausage', 'carnitas', 'ribs', 'tenderloin', 'chorizo', 'pork belly', 'pork chop', 'pork shoulder', 'spare rib', 'lard', 'guanciale', 'mortadella'] },
    { label: 'Seafood',    icon: '🐟', keywords: ['salmon', 'shrimp', 'fish', 'tuna', 'cod', 'halibut', 'crab', 'lobster', 'scallop', 'seafood', 'tilapia', 'mahi', 'clam', 'mussel', 'oyster', 'trout', 'bass', 'snapper', 'anchovy', 'prawns', 'squid', 'calamari', 'octopus', 'sea bass', 'branzino', 'monkfish', 'sardine'] },
    { label: 'Lamb',       icon: '🍖', keywords: ['lamb', 'mutton', 'rack of lamb', 'leg of lamb', 'lamb chop', 'lamb shank', 'ground lamb', 'lamb shoulder'] },
    { label: 'Vegetarian', icon: '🥦', keywords: ['vegetarian', 'vegan', 'tofu', 'lentil', 'chickpea', 'tempeh', 'mushroom', 'cauliflower', 'eggplant', 'veggie', 'plant-based', 'meatless', 'butternut', 'squash', 'zucchini', 'jackfruit', 'seitan', 'black bean', 'white bean', 'cannellini', 'kidney bean', 'edamame', 'portobello'] },
    { label: 'Other',      icon: '🍳', keywords: ['egg', 'eggs', 'turkey', 'duck', 'venison', 'bison', 'rabbit', 'quail', 'goat', 'offal', 'liver', 'oxtail', 'bone broth', 'bone-in', 'game', 'elk', 'wild boar', 'pheasant'] },
  ],
  time: [
  ...
  meal: [
    { label: 'Breakfast',  icon: '🥞', keywords: ['breakfast', 'brunch', 'pancake', 'waffle', 'french toast', 'omelette', 'omelet', 'frittata', 'granola', 'muffin', 'scone', 'benedict', 'hollandaise', 'eggs florentine', 'overnight oats', 'smoothie bowl', 'morning', 'quiche', 'crepe', 'crêpe', 'avocado toast', 'hash brown', 'hashbrown', 'strata', 'shakshuka', 'breakfast burrito', 'breakfast sandwich', 'breakfast bowl', 'oatmeal', 'porridge', 'bagel', 'acai bowl', 'egg bake', 'egg casserole', 'breakfast casserole', 'dutch baby'] },
    { label: 'Lunch',      icon: '🥗', keywords: ['sandwich', 'wrap', 'grain bowl', 'lunch', 'salad', 'soup', 'poke', 'bento', 'panini', 'hoagie', 'tuna melt', 'grilled cheese', 'pasta salad', 'noodle salad', 'flatbread', 'open-faced', 'tartine', 'rice bowl', 'noodle bowl', 'lettuce cup', 'summer roll'] },
    { label: 'Dinner',     icon: '🍽️', keywords: ['dinner', 'supper', 'weeknight', 'roast', 'entrée', 'entree', 'main course', 'main dish', 'stew', 'pasta', 'curry', 'casserole', 'ragù', 'ragu', 'braise', 'braised', 'gratin', 'fricassee', 'hash', 'skillet dinner', 'sheet pan dinner', 'one pot dinner'] },
    { label: 'Dessert',    icon: '🍰', keywords: ['cake', 'cookie', 'brownie', 'dessert', 'pie', 'tart', 'ice cream', 'pudding', 'cheesecake', 'cupcake', 'frosting', 'fudge', 'mousse', 'tiramisu', 'gelato', 'sorbet', 'crisp', 'cobbler', 'biscotti', 'macaron', 'donut', 'doughnut', 'pastry', 'éclair', 'custard', 'creme brulee', 'chocolate', 'caramel', 'bars', 'blondie', 'banana bread', 'zucchini bread', 'quick bread', 'bundt', 'churro', 'panna cotta', 'tres leches', 'flan', 'praline', 'toffee', 'brittle', 'lemon curd', 'clafoutis', 'financier', 'profiterole', 'beignet'] },
    { label: 'Snack/Side', icon: '🥨', keywords: ['snack', 'appetizer', 'side dish', 'dip', 'starter', 'finger food', 'small plate', 'nibble', 'chips', 'hummus', 'salsa', 'guacamole', 'bruschetta', 'crostini', 'deviled eggs', 'nachos', 'skewer', 'charcuterie', 'cheese board', 'poppers', 'fries', 'onion rings', 'spring rolls', 'potstickers', 'meatballs', 'flatbread', 'roasted vegetables', 'roasted veggies', 'pickle', 'pickled'] },
    { label: 'Drinks',     icon: '🥤', keywords: ['cocktail', 'mocktail', 'smoothie', 'juice', 'lemonade', 'iced tea', 'drink', 'beverage', 'shake', 'margarita', 'sangria', 'punch', 'spritz', 'agua fresca', 'latte', 'cold brew', 'shrub', 'syrup', 'iced coffee', 'hot chocolate', 'cider', 'kombucha', 'milk tea', 'bubble tea', 'chai latte', 'chai tea', 'matcha latte', 'golden milk', 'switchel', 'kefir drink', 'infused water', 'simple syrup'] },
  ],
  dietary: [
