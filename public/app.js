...
const FILTERS = {
  ...
  meal: [
    ...
    { label: 'Drinks',     icon: '🥤', keywords: ['cocktail', 'mocktail', 'smoothie', 'juice', 'lemonade', 'iced tea', 'drink', 'beverage', 'shake', 'margarita', 'sangria', 'spritz', 'fruit punch', 'rum punch', 'party punch', 'holiday punch', 'agua fresca', 'latte', 'cold brew', 'shrub', 'syrup', 'iced coffee', 'hot chocolate', 'cider', 'kombucha', 'milk tea', 'bubble tea', 'chai latte', 'chai tea', 'matcha latte', 'golden milk', 'switchel', 'kefir drink', 'infused water', 'simple syrup', 'horchata', 'lassi', 'frappe', 'espresso martini', 'ginger beer', 'green juice', 'protein shake', 'mojito', 'daiquiri', 'negroni', 'old fashioned', 'paloma', 'aperol', 'mulled wine', 'wassail', 'tepache', 'fire cider', 'electrolyte'] },
  ],
  dietary: [
